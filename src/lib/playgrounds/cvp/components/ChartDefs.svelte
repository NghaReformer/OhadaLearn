...
<defs>
	<linearGradient id="cvp-profitFill" x1="0" y1="0" x2="0" y2="1">
		<stop offset="0%" stop-color="#2dd4a0" stop-opacity="0.14" />
		<stop offset="100%" stop-color="#2dd4a0" stop-opacity="0.01" />
	</linearGradient>
	<linearGradient id="cvp-lossFill" x1="0" y1="0" x2="0" y2="1">
		<stop offset="0%" stop-color="#f0605e" stop-opacity="0.01" />
		<stop offset="100%" stop-color="#f0605e" stop-opacity="0.14" />
	</linearGradient>
	<linearGradient id="cvp-revLine" x1="0" y1="1" x2="1" y2="0">
		<stop offset="0%" stop-color="#1aae82" />
		<stop offset="100%" stop-color="#2dd4a0" />
	</linearGradient>
	<linearGradient id="cvp-costLine" x1="0" y1="1" x2="1" y2="0">
		<stop offset="0%" stop-color="#d44a48" />
		<stop offset="100%" stop-color="#f0605e" />
	</linearGradient>
	<linearGradient id="cvp-pvLine" x1="0" y1="1" x2="1" y2="0">
		<stop offset="0%" stop-color="#6366f1" />
		<stop offset="100%" stop-color="#7c7fff" />
	</linearGradient>
	<filter id="cvp-glow">
