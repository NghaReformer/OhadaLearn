...
export const tvmFr: TranslationMap = {
	...
	'tvm.inv.panel.flows': 'Flux de tr\u00e9sorerie',
	'tvm.inv.panel.rates': 'Taux',
	'tvm.inv.panel.metrics': 'Indicateurs',
	'tvm.inv.flows.period': 'P\u00e9riode',
	'tvm.inv.flows.amount': 'Montant',
	'tvm.inv.flows.add': 'Ajouter une p\u00e9riode',
	'tvm.inv.flows.remove': 'Supprimer',
	'tvm.inv.rate.discount': 'Taux d\u2019actualisation',
	'tvm.inv.rate.finance': 'Taux de financement',
	'tvm.inv.rate.reinvest': 'Taux de r\u00e9investissement',
	'tvm.inv.rate.financeHint': 'Utilis\u00e9 pour actualiser les flux n\u00e9gatifs dans le calcul du TRIM.',
	'tvm.inv.rate.reinvestHint': 'Utilis\u00e9 pour capitaliser les flux positifs dans le calcul du TRIM.',
	'tvm.inv.metric.npv': 'Valeur actuelle nette (VAN)',
	'tvm.inv.metric.irr': 'Taux de rendement interne (TRI)',
	'tvm.inv.metric.mirr': 'TRI modifi\u00e9 (TRIM)',
	'tvm.inv.metric.payback': 'D\u00e9lai de r\u00e9cup\u00e9ration',
	'tvm.inv.metric.discountedPayback': 'D\u00e9lai de r\u00e9cup\u00e9ration actualis\u00e9',
	'tvm.inv.metric.pi': 'Indice de rentabilit\u00e9',
	'tvm.inv.metric.totalInflow': 'Total des entr\u00e9es',
	'tvm.inv.metric.totalOutflow': 'Total des sorties',
	'tvm.inv.metric.noIrr': 'TRI non d\u00e9fini (les flux doivent inclure les deux signes)',
	'tvm.inv.metric.noMirr': 'TRIM non d\u00e9fini',
	'tvm.inv.metric.noPayback': 'Jamais r\u00e9cup\u00e9r\u00e9',
	'tvm.inv.metric.piDecision': 'Accepter si IR \u2265 1.',
	'tvm.inv.metric.npvDecision': 'Accepter si VAN > 0.',
	'tvm.inv.metric.irrDecision': 'Accepter si TRI d\u00e9passe le taux cible.',
	'tvm.inv.validation.minFlows': 'Au moins deux flux de tr\u00e9sorerie sont requis.',
	'tvm.inv.validation.noSignChange': 'Les flux sont tous de m\u00eame signe \u2014 TRI et r\u00e9cup\u00e9ration ind\u00e9finis.',
	'tvm.inv.preset.simple': 'Projet simple (\u2212100\u202f000, 5 \u00d7 30\u202f000)',
	'tvm.inv.preset.unequal': 'Entr\u00e9es in\u00e9gales',
	'tvm.inv.preset.lease': 'Location d\u2019exploitation',
	'tvm.inv.workings.periods': '\u00c9tendue des p\u00e9riodes',
	'tvm.inv.workings.pvNeg': 'VA des sorties (au taux de financement)',
	'tvm.inv.workings.fvPos': 'VF des entr\u00e9es (au taux de r\u00e9investissement)'
};
